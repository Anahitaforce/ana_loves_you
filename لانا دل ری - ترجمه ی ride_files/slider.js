...
//***********************************************
jQuery.fn.sliderlana = function(am) {
    var aI = jQuery;
    var H = this;
    var y = H.get(0);
    ...
    am = aI.extend({
        ...
        autoPlayVideo: false,
        responsive: 1,
        support: jQuery.fn.sliderlana.support,
        stopOnHover: 0,
        preventCopy: 1
    }, am);
    var C = navigator.userAgent;
    var au = aI(".slider_image", H).css("overflow", "visible");
    ...
    var b = am.images && (new sliderlanaPreloader(this, am));
    var aQ = au.find("li");
    var z = aQ.length;
    ...
    if (typeof sliderlanaVideo == "function") {
        var F = aI('<div class="ws_video_btn"><div></div></div>').appendTo(au);
        at = new sliderlanaVideo(H, am, n);
